...
-- Move-- kde-material-you-colors spawns a window when changing dark/light theme. This is to make sure it doesn't interfere at all.
...
hl.window_rule({ match = { class = "^(plasma-changeicons)$" }, move = { 999999, 999999 } }) -- stupid dolphin copy
...
-- ######## Layer rules ########
hl.layer_rule({ match = { namespace = ".*" }, xray = true }) -- layerrule = match:namespace .*, no_anim on
